...
from app.api.v1.endpoints import auth, attendance, leave, admin, profile, records, onboarding, salary, deduction, payroll, overtime, razorpay, communication
...
api_router.include_router(communication.router, prefix="/comms", tags=["Communications"])
