...
class LeaveBalance(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    emp_id = Column(Unicode(50), ForeignKey("employees.emp_id"), index=True)
...
class LeaveRequest(Base):
    ...
    # Relationships
    owner = relationship("Employee", primaryjoin="LeaveRequest.emp_id == Employee.emp_id", foreign_keys=[emp_id], backref="leave_requests")
...
class LeaveApprovalLog(Base):
    ...
    approver_id = Column(Unicode(50), ForeignKey("employees.emp_id"))
